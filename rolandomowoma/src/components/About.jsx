    ...
    <div name='about' className='w-full h-screen bg-[#142d53] text-gray-300'>
        <div className='flex flex-col justify-center items-center w-full h-full'>
            ...
            <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
                ...
                <div>
                    <p>I'm passionate about building software that improves the lives of 
                            those around me. I specialize in creating sftware for clients
                            ranging from individuals to organizations of all categories.
